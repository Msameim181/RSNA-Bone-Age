...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        features: List[nn.Module] = [
            Conv2dNormActivation(image_channels, input_channel, stride=2, norm_layer=norm_layer, activation_layer=nn.ReLU6)
        ]
    ...
    def _forward_impl(self, x: Tensor, y) -> Tensor:
...
if __name__ == '__main__':
    ...
    model = MobileNetV2(image_channels=1, num_classes=229, width_mult=1.0, inverted_residual_setting=inverted_residual_setting)
    # print(model)
    model.cuda()
